...
export class Tetromino {
  ...
  moveTo(row, col) {
    return new Tetromino(this.#orientations, this.#index, this.#movingShape.moveTo(row, col));
  }
  ...
  moveRight() {
    return new Tetromino(this.#orientations, this.#index, this.#movingShape.moveRight());
  }

  moveDown() {
    return new Tetromino(this.#orientations, this.#index, this.#movingShape.moveDown());
  }
